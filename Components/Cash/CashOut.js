    ...
    return (
        <View>
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', width: '100%', alignItems: 'center', marginVertical: metrics.verticalScale(20),paddingHorizontal: metrics.horizontalScale(20)}}>
                <Image source={require('../../Assets/Images/red.png')} style={{ zIndex: 2 }} />
                <View>
                    <Text style={{ color: '#ED1C24', fontSize: 24, fontWeight: '600', marginBottom: metrics.verticalScale(5) }}>₹ 22.00</Text>
                    <Text style={{ color: '#828282', fontSize: 18, fontWeight: '500' }}>Cash Out</Text>
                </View>
                <View>
